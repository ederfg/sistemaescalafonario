...
<div class="container">
    ...
    <div class="col-md-12 order-md-1">
        ...
        <form class="needs-validation" ng-submit="guardarTodoAdministrativo(empleado, administrativo, datoslaboral, listadatosacademicos, datosfamilia, listadatoshijos)">
            <div class="row">
