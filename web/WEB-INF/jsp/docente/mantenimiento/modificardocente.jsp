...
<div class="container">
 ...
 <center>    
  ...
  <li class="list-group-item"><button class="btn btn-primary btn-lg" ng-click="mostrarDatosPersonales()" fixed-bottom>Modificar Datos Personales</button></li>
  <li class="list-group-item"><button class="btn btn-success btn-lg" ng-click="mostrarDatosDocente()" fixed-bottom>Modificar Datos Docente</button></li>
  <li class="list-group-item"><button class="btn btn-warning btn-lg" ng-click="mostrarDatosLaboral()">Modificar Datos Laboral</button></li>
  ...
  <li class="list-group-item"><button class="btn btn-dark btn-lg" ng-click="mostrarDatosFamilia()">Modificar Datos familia</button></li>
</ul>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="custom-select d-block w-100" ng-model="datoslaboral.facultad" id="facultad" required>
                                ...
                                <option value="FACULTAD DE CIENCIAS ECONOMICAS , ADMINISTRATIVAS Y CONTABLES">FACULTAD DE CIENCIAS ECONOMICAS , ADMINISTRATIVAS Y CONTABLES</option>
...
<!-- <div class="container">
    <div class="py-5 text-center">
        <i class="material-icons md-48">assignment_ind</i>  
        <h2>MODIFICAR DATOS DEL PERSONAL</h2>
        <p class="lead">Modifique los datos requeridos del docente, luego guarde los cambios.</p>
    </div>
        ...
        <form class="needs-validation" novalidate>
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <div class="invalid-feedback">
                        Es obligatorio ingresar el código
                    </div>
                </div>
                <div class="col-md-4 mb-3">
                    <label for="fechaIngreso">Fecha Ingreso a la Institución</label>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="invalid-feedback">
                        Por favor selecciona un régimen de dedicación. 
                    </div>
                </div> 
                <div class="col-md-4 mb-3">
                    <label for="tipoContrato">Tipo de Contrato</label>
