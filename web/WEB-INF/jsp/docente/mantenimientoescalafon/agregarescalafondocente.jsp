<%-- 
    Document   : agregarescalafondocente
    Created on : 15/03/2018, 08:19:40 PM
    Author     : José
--%>
...
<div class="container">
    <div class="py-5 text-center">
        ...
        <p class="lead">Para ingresar un registro eslafonario de un docente ingrese su DNI y busque, luego completa los datos que se requieran.</p>
    </div>

    <div class="col-md-12 order-md-1">
        <h4 class="mb-3">DATOS ESCALAFONARIOS DEL DOCENTE</h4>
